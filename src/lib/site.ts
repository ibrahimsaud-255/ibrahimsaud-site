...
// sketchfab: معرّف نموذج Sketchfab (embed) لعرض ثلاثي الأبعاد.
// image: مسار صورة المنتج داخل public (مثل "/gear/venusliv-air.jpg").
...
export type PodcastGearItem = {
  ...
  desc: string;
  sketchfab?: string; // معرّف نموذج Sketchfab (عرض ثلاثي الأبعاد)
  image?: string; // صورة المنتج (بديل العرض الثلاثي)
...
export const podcastGear: PodcastGearItem[] = [
  ...
  },
  {
    ...
    sketchfab: "7b2abd7d17c74645912ff4ff606b7512",
...
// ⚠️ الأسعار أدناه مقترحة — عدّلها بسهولة من هنا حسب ما يناسبك.
