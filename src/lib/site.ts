...
// avatar: مفتاح الرسمة الكرتونية للشخصية — القيم المتاحة في PersonaAvatar:
//   "marketer" | "executive" | "founder" | "merchant"
export type Persona = {
  name: string; // اسم الشخصية الافتراضي
  role: string; // المسمّى الوظيفي
  org: string; // الشركة/المتجر المثال + حجمه
  age: string; // العمر التقريبي
  avatar: "marketer" | "executive" | "founder" | "merchant";
  needs: string; // وش يحتاج (احتياجه الأساسي)
  why: string; // ليش يحتاجني تحديداً
};
...
export type AudienceSegment = {
  ...
  personas: Persona[]; // أصحاب القرار داخل هذه الفئة
};
    ...
    personas: [
      {
        name: "أ. فيصل",
        role: "مدير التسويق",
        org: "شركة كبيرة / جهة — فريق تسويق وميزانية سنوية",
        age: "٣٨ سنة",
        avatar: "marketer",
        needs:
          "محتوى مؤسسي عالي الجودة ينفّذ خطة العام، يليق بالعلامة ويُسلَّم في وقته.",
        why: "يبي شريك إنتاج واحد يمسك المشروع من الفكرة للتسليم بدون متابعة مرهقة، ويلتزم بالهوية والطابع الرسمي.",
      },
      {
        name: "م. عبدالعزيز",
        role: "المدير التنفيذي",
        org: "إدارة عليا في جهة/شركة — صاحب القرار النهائي",
        age: "٤٥ سنة",
        avatar: "executive",
        needs:
          "صورة ذهنية راقية للجهة أمام الشركاء والجمهور، وفيلم يمثّل مكانتها في المناسبات.",
        why: "يبي مصداقية وإتقان يعكسان مستوى الجهة، وثقة إن الإنتاج بيطلع بمستوى يفتخر يعرضه.",
      },
    ],
  },
  {
    ...
    personas: [
      {
        name: "سعود",
        role: "رائد أعمال — متجر واحد",
        org: "متجر إلكتروني ناشئ — يدير كل شيء بنفسه",
        age: "٢٧ سنة",
        avatar: "founder",
        needs:
          "مقاطع إعلانية تبيع منتجه بأقل تكلفة، جاهزة للنشر فوراً على المنصات.",
        why: "ميزانيته محدودة ويبي نتيجة سريعة — يحتاج هوك قوي وسعر مناسب وباقة واضحة بدون تعقيد.",
      },
      {
        name: "نوّاف",
        role: "تاجر — عدّة متاجر/علامات",
        org: "يملك أكثر من متجر — يبحث عن مزوّد محتوى ثابت",
        age: "٣٣ سنة",
        avatar: "merchant",
        needs:
          "تدفّق محتوى منتظم لكل متاجره: إعلانات، مراجعات، ومقاطع قصيرة بكميات.",
        why: "يبي شريك إنتاج يفهم الأداء ويسلّم بكمية وسرعة وسعر يكبر مع حجم طلباته.",
      },
    ],
  },
];
