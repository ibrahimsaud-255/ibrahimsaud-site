...
export const processSteps = [
  {
    n: "01",
    title: "نفهم منتجك",
    desc: "الهدف، الجمهور، والرسالة الواحدة التي يخرج بها المشاهد — قبل أي كاميرا.",
  },
  {
    n: "02",
    title: "نكتب الهوك والسكربت",
    desc: "أول ثانيتين توقف التمرير، والباقي يوصّل الفكرة وينتهي بدعوة واضحة.",
  },
  {
    n: "03",
    title: "نصوّر طولي ٩:١٦",
    desc: "تصوير بإضاءة وصوت احترافي، وكادر مبني للجوال من البداية — لا قصّ من فيديو أفقي.",
  },
  {
    n: "04",
    title: "مونتاج وتسليم",
    desc: "قص وإيقاع وموسيقى ونص على الشاشة، وتستلمه جاهزاً لتيك توك وريلز وسناب وشورتس.",
  },
] as const;
