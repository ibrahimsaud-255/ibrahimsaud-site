  ...
  ventures: [
    {
      ...
      /* الرابط للمنصّة العامّة لا للوحة الإدارة — البطاقة كانت تدلّ كلّ زائر
         على ibrahimsaud.com/app (النظام الداخليّ). */
...
// ===== كيف نشتغل (رحلة الإعلان الطولي) =====
export const processSteps = [
  {
    n: "01",
    title: "ترسل لي منتجك",
    desc: "رسالة واتساب تكفي: وش تبيع، مين جمهورك، ووش تبي الإعلان يحقّق.",
  },
  {
    n: "02",
    title: "أكتب الهوك والسكربت",
    desc: "فكرة مبنية على منتجك، أول ثانيتين توقف التمرير — وتعتمدها أنت قبل أي كاميرا.",
  },
  {
    n: "03",
    title: "نصوّر طولي ٩:١٦",
    desc: "في موقعك بالرياض أو في استوديو مجهّز — إضاءة وصوت احترافي، وكادر مبني للجوال لا مقصوص من فيديو أفقي.",
  },
  {
    n: "04",
    title: "تستلم خلال ٣ أيام",
    desc: "مونتاج وموسيقى ونص على الشاشة، وجولتا تعديل مجانية — ثم انشره وأنت مطمئن.",
  },
] as const;
...
export const adPackages: AdPackage[] = [
  {
    ...
    tagline: "ابدأ بإعلان واحد وشوف الفرق بنفسك",
    features: [
      "فكرة وسكربت مبني على منتجك وجمهورك — تعتمده قبل التصوير",
      "تصوير طولي ٩:١٦ بإضاءة وصوت احترافي",
      "مونتاج كامل: قص وإيقاع وموسيقى ونص على الشاشة",
      "تسليم خلال ٣ أيام + جولتا تعديل مجانية",
    ],
  },
  {
    id: "review",
    ...
    tagline: "مراجعة تبني ثقة المتردّد وتقنعه يشتري",
    features: [
      "سكربت مراجعة يبرز المزايا بصدق — بلا مبالغة تكسر الثقة",
      "تصوير تفصيلي للمنتج + لقطات استخدام واقعية",
      "جرافيك على الشاشة يبرز النقاط اللي تهم المشتري",
      "تسليم خلال ٣ أيام + جولتا تعديل مجانية",
    ],
  },
  {
    ...
    tagline: "٣ أفكار مختلفة — تعرف أيّها يبيع قبل ما تصرف على الإعلانات",
    features: [
      "٣ إعلانات بزوايا وأفكار مختلفة لنفس المنتج",
      "تختبر أي فكرة تشتغل مع جمهورك قبل صرف ميزانية الإعلانات",
      "تصوير ومونتاج احترافي لكل إعلان",
      "محتوى يكفيك أسابيع نشر على كل المنصات",
    ],
  },
];
