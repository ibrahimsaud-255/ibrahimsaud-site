...
const processFallback = {
  label: "كيف نشتغل",
  title: "من رسالة واتساب إلى إعلان جاهز — في ٣ أيام.",
  sub: "ما تحتاج وكالة ولا فريق ولا اجتماعات: شخص واحد يمسك الفكرة والسكربت والتصوير والمونتاج، وأنت تعتمد وتستلم.",
