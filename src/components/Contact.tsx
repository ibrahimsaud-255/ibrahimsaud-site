...
const contactFallback = {
  ...
  sub: "راسلني على واتساب واحكِ لي عن منتجك وجمهورك — وأرجع لك بفكرة الإعلان وعرض السعر.",
  cta1: {
    label: "اطلب إعلانك عبر واتساب",
    waMsg: "السلام عليكم إبراهيم، أبي فيديو إعلاني لمنتجي 🎬",
  },
  cta2: {
    label: "استفسر عن الأسعار",
    waMsg: "السلام عليكم، أبي أستفسر عن أسعار الفيديوهات الإعلانية. منتجي: ",
  },
};
