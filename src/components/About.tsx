        ...
        <Reveal>
          <div>
            ...
            <p className="mt-4 leading-relaxed text-cream/70">
              خبير في إنتاج الفيديوهات الإعلانية وصانع محتوى تسويقي. اشتغلت مع
              علامات تجارية رائدة في السعودية والخليج بأكثر من{" "}
              <span className="text-gold">١٠٠</span> فيديو إعلاني. وأملك{" "}
              <span className="text-gold">سَعي</span> — شركة إنتاج واستديو ننتج
              فيه المحتوى والبرامج.
            </p>
            <p className="mt-4 leading-relaxed text-cream/70">
