...
const heroFallback = {
  ...
  title: "أُخرج قصتك *كما تستحق أن تُروى*.",
  sub: "أقود العمل من الفكرة حتى التسليم — كتابةً وإخراجاً وتصويراً ومونتاجاً. أفلام، حملات، بودكاست، وتغطيات لعلامات في السعودية والخليج، بأكثر من ٣٠ عملاً مرئياً.",
  cta1: {
    label: "ابدأ مشروعك",
