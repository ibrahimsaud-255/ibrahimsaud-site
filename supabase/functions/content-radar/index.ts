...
- hook: جملة صادمة أو سؤال مثير يوقف التمرير فوراً، لهجة سعودية بيضاء. ⛔ تجنّب الجمل الضعيفة المختصرة مثل «الذكاء ينمو!».
- script: يُقرأ في 30–45 ثانية، لهجة سعودية/خليجية محكية طبيعية، يبسّط الخبر ويعطي زاوية/فائدة. **اكتب فقط بناءً على العنوان؛ ممنوع اختراع أرقام أو تفاصيل أو اقتباسات أو أسماء غير موجودة فيه.** لو العنوان غير كافٍ، تحدّث عن الموضوع عموماً.
