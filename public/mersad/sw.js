...
const STATIC_ASSETS = [
  '/mersad/fonts/thmanyahsansLight.otf',
  '/mersad/fonts/thmanyahsansRegular.otf',
  '/mersad/fonts/thmanyahsansMedium.otf',
  '/mersad/fonts/thmanyahsansBold.otf',
  '/mersad/fonts/thmanyahsansBlack.otf',
  '/mersad/fonts/thmanyahserifdisplayLight.otf',
  '/mersad/fonts/thmanyahserifdisplayRegular.otf',
  '/mersad/fonts/thmanyahserifdisplayMedium.otf',
  '/mersad/fonts/thmanyahserifdisplayBold.otf',
  '/mersad/fonts/thmanyahserifdisplayBlack.otf',
  '/mersad/icon-192.png',
  '/mersad/icon-512.png',
];
    ...
    fetch(e.request)
      ...
      .catch(() => caches.match(e.request).then(cached => cached ||
        (e.request.mode === 'navigate'
          ? caches.match('/mersad/').then(r => r || caches.match('/mersad/index.html'))
          : undefined)
      ))
  );
});
